...
//full constructor
WatermarkFunctions::WatermarkFunctions(const af::array &rgb_image, const af::array& image, const string &w_file_path, const int p, const float psnr, const cl::Program& program_me, const cl::Program& program_custom, const string &custom_kernel_name)
